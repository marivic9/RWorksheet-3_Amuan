...
#ANSWER: The scatterplot visually demonstrates distinct clusters for each Iris species (setosa, versicolor, and virginica) based on Sepal #Length and Sepal Width, with setosa clearly separated from the other two, showcasing both species-specific characteristics and potential #areas of overlap between versicolor and virginica.
...
compPlot <- barplot(var$n,
            ...
            cex.names = 0.50, 
            space = 0.10)
legend("topright", legend = varNames, fill = 1:16, title = "Variation Names", cex = 0.45)

knitr::include_graphics("/cloud/project/Worksheet#4/Product Variation.png")
...
mtext("Variations", side = 2, line = 2, cex = 1.2)
knitr::include_graphics("/cloud/project/Worksheet#4/BlackWhite Variation.png")
